--[[
    ...
    This file handles:
    - Automatic framework detection (LXR-Core, RSG-Core, VORP, QBR, RedEM, Standalone)
    - Framework-specific API abstraction
    - Unified interface for player data, money, inventory, and jobs
    - Cross-framework compatibility without code changes
]]
